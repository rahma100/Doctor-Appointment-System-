...
--
-- Host: 127.0.0.1
-- Generation Time: May 15, 2022 at 03:55 AM
...
INSERT INTO `medicine` (`description`, `id`, `price`, `title`) VALUES
('Analgesia and antipyresis PO\r\n', 1, 20, 'Panadol'),
('Anti-cough, antitussive and expectorant Syrup\r\n', 2, 11, 'Oplex'),
('Used for Headache, fever, body aches\r\n', 3, 19.5, 'congestal'),
('Osteoarthritis  for each elbow, wrist, or hand\r\n', 4, 36, 'Catafast'),
('Osteoarthritis for each elbow, wrist, or hand\r\n\r\n', 5, 16.5, 'Cataflam'),
('This combination medication is used to temporarily treat cough, stuffy nose, body aches, and other symptoms (e.g., fever, headache, sore throat) caused by the common cold, flu, or other breathing illnesses (e.g., sinusitis, bronchitis)', 6, 30, 'Comtrex Acute Head Cold'),
('Flurest N 20 tablets. Anticatarrhal, Analgesic, Decongestant && Antihistamine', 7, 4.5, 'Flurest'),
('For the treatment of Common Cold && influenza, Anticatarrhal, Decongestant, Antihistaminic, Analgesic && Antipyretic.', 8, 18, 'Power Cold & Flu '),
('Used to boost immunity, improve recovery from cold and flu, and in cases of vitamin c or zinc deficiency Dosage: 1 tablet per day', 9, 25, 'Immuno-Mash Vitamin C & Zinc '),
('Indicated for suspected acute diarrhea caused by bacteria. Dosage: Unless otherwise prescribed by the physician, the usual dose is: - Adults : 1 capsule 4 times daily. - Children Over 2 year : 1 teaspoonful (5 ml) 4 times daily & not exceeding 7 days.', 10, 21, 'Antinal 200 mg '),
('cream Prevents the formation of flakes, cracks, and fissures as well as hydrating and softening the deepest layers of the dry skin.', 11, 35, 'Macro Panthenol Cream  '),
('Aspocid tablet is used to reduce fever and mild to moderate pain from a headache, menstrual periods, cold, toothache, or muscle ache. This medicine works by reducing the effects of a chemical in the body that causes fever.', 12, 9, 'Aspocid Paediatric '),
('Omega-3s (short for omega-3 fatty acids) are a kind of fat found in foods and in the human body. They are also sold as dietary supplements', 13, 55, 'Omega-3 Plus  '),
('Antibiotic, belongs to the macrolides group used in the treatment of pneumonia, Streptococcus infections, sexually transmitted infections, mycobacterial infection, Lyme disease, infectious diarrhea, bronchiolitis and inflammatory acne vulgaris.', 14, 45, 'Xithrone 500 mg ');
